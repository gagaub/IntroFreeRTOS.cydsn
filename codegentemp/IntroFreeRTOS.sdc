...
# Date: Wed, 10 Mar 2021 21:52:32 GMT
#set_units -time ns
...
create_generated_clock -name {UART_1_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 37 73} [list [get_pins {ClockBlock/ff_div_0}]]
